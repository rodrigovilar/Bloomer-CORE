...
var action; // Responsável por definir se o parâmetro action irá chamar CREATE_1u UPDATE.
...
function READ_1(){
	...
	$.getJSON("http://localhost:8080/Bloomer-CORE/"+ entity,
		function(json){
			...
			// In buildForm function, 1 its a parameter who means CREATE_1			var title = '<tr><td colspan="6"><a href="#" onclick="buildForm(1);"><img src="../images/create_1ng"/>Add</a></td></tr>';
			table.append(title);
...
function buildForm(type){
	...
	if (type == 1){
		action = "javascript:CREATE_1";
		submit_button = "Save";
	} else if (type == 2){
		action = "javascript:UPDATE_1()";
		submit_button = "Edit";
	}
