...
@RooToString
@RooJson
@RooJpaActiveRecord(finders = { "findUsuariosByPartidas", "findUsuariosByLoginEqualsAndSenhaEquals" })
public class Usuario {
    ...
    public static String toJsonArray(Collection<br.ufpb.dce.bloomer.core.model.Usuario> collection) {
    ...
    private static ObjectNode usuario2json(br.ufpb.dce.bloomer.core.model.Usuario usuario) {
    ...
    public static br.ufpb.dce.bloomer.core.model.Usuario fromJsonToUsuario(String json) {
